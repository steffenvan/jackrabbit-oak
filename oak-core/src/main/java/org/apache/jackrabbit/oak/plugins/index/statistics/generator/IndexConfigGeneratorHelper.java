...
public class IndexConfigGeneratorHelper {
	...
	private static void extractQueriesAndGenerateIndex(String queryText, IndexConfigGenerator generator)
		...
		while (true) {
			...
			if (lowercasedLine.startsWith("select") || lowercasedLine.startsWith("sql1")
					|| lowercasedLine.startsWith("/")) {
	...
	/**
	 * Taken from org.apache.jackrabbit.oak.query.AbstractQueryTest A line reader
	 * that supports multi-line statements, where lines that start with a space
	 * belong to the previous line.
	 */
